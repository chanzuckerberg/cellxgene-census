...
python -m census_contrib ingest-npy --cwd CxG-contrib-2 -v --joinid-path fixed_human_soma_join_ids.npy --embedding-path cxg_human_2023-10-23_62996451_19715_uce_proc.npy
python -m census_contrib ingest-npy --cwd CxG-contrib-3 -v --joinid-path cxg_mouse_2023-10-23_soma.npy --embedding-path cxg_mouse_2023-10-23_5684805_22270_uce_proc.npy
python -m census_contrib ingest-npy --cwd CxG-contrib-4 -v --joinid-path tmp/joinids.npy --embedding-path tmp/h_matrix.npy
