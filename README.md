...
Get started on using the CELLxGENE Discover Census:
...
## CELLxGENE Discover Census data releases

Starting in mid 2023, CELLxGENE Discover Census long-term supported data builds will be released every 6 months and will be publicly accessible for at least 5 years after release. 

In between long-term supported data build releases, weekly builds will be released without any guarantee of permanence. 

## CELLxGENE Discover Census data organization
...
The Census requires a Linux or MacOS system with:
...
The CELLxGENE Discover Census [doc-site](https://chanzuckerberg.github.io/cellxgene-census/index.html) (*under development*), contains the reference documentation, data description, and tutorials.
