---
title: "Access CZI-maintained embeddings (scVI, Geneformer)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Access CZI-maintained embeddings (scVI, Geneformer)}
...
census <- cellxgene.census::open_soma(census_version = "2023-12-15")
```
