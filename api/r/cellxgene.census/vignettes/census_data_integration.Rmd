...
seurat_obj = cellxgene.census::get_seurat(
    ...
    obs_value_filter="dataset_id %in% c('4546e757-34d0-4d17-be06-538318925fcd', '6202a243-b713-4e12-9ced-c387f8483dea')"
)
```
...
```{r}
# By assay
#Idents(object = seurat_obj) <- seurat_obj$assay
p1 <- DimPlot(seurat_obj, reduction = "umap", group.by = "assay")

# By cell type
#Idents(object = seurat_obj) <- seurat_obj$cell_type
