...
ctx <- tiledbsoma::SOMATileDBContext$new(
  config = c("soma.init_buffer_bytes" = "4294967296")
)
...
```{r}
obs_query <- tiledbsoma::SOMAAxisQuery$new(value_filter = "tissue_ontology_term_id=='UBERON:0002048' && sex_ontology_term_id=='PATO:0000383' && cell_type_ontology_term_id %in% c('CL:0002063', 'CL:0000499')")
