...
print(expt_query)
# print(expt_query$n_obs)
# print(expt_query$n_var)
...
The `CellCensus::download_source_h5ad()` API downloads the H5AD to a local file, which can then be used in R by (TODO).
